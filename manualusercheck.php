...
function getUser($id){
	...
	curl_setopt($ch, CURLOPT_URL, "https://api.litmos.com/v1.svc/users/$id?apikey=3B47E4B8-2DA6-4832-B82F-D81ABAE7110A&source=MY-APP&limit=1000");
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
	curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
...
function addUserToTeam($teamId,$userId){
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => "https://api.litmos.com/v1.svc/teams/".$teamId."/users?apikey=3B47E4B8-2DA6-4832-B82F-D81ABAE7110A&source=MY-APP",
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		echo $user_records = $wa_contacts[$user_wa_contacts];
