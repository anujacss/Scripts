...
$bearer_token = $response['access_token'];	
	...
	$curl = curl_init();
  $content = json_encode(array("username" => ''.$wa_apricot["FirstName"].'_'.$wa_apricot["LastName"].'',"name" => ''.$wa_apricot["FirstName"].' '.$wa_apricot["LastName"].'',"email" => ''.$wa_apricot["Email"].'',"password" => 'ACss1234$', "role" => 'member'));
curl_setopt_array($curl, array(
